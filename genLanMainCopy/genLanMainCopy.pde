...
void setup() {
  ...
  textures = new PImage[]{ loadImage("brick1.png"), loadImage("brick1_moss.png"), loadImage("bricksmall.png"),
                           loadImage("bricklarge.png"), loadImage("mossymulti.png"), loadImage("muticolorbrick.png")
                           };
